...
for (let course of tasks) {
  ...
  <div>
    ...
    <button type="submit" value="delete" class="btn_delete bg-danger">    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-trash" viewBox="0 0 16 16">
