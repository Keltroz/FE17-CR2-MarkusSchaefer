...
for (let course of tasks) {
  ...
  <div>
    ...
    Priority level: <button type="submit" class="btn_prio"><span class="prio_amount">${course.priority}</span></button><br>
...
function prio(index) {
  if (tasks[index].priority != 5) {
    ...
    document.getElementsByClassName("prio_amount")[index].innerHTML =
      tasks[index].priority;
  }
}
...
// document.getElementsByClassName("btn_prio")[0].onclick = function(){
//     tasks[0].priority++;
//     document.getElementsByClassName("prio_amount")[0].innerHTML = tasks[0].priority;
// }
